...
<div class="container py-5">
    <div class="payment-status-card">
        ...
        @elseif ($order->status == 'failed' || $order->status == 'cancelled')
            <a href="{{ route('payment.statuss', $order->id) }}" class="badge bg-danger">Failed</a>
        ...
        <div class="text-center mt-4">
            <a href="{{ route('payment.statuss', $order->id) }}" class="btn btn-outline-secondary">Check Status Again</a>
            <a href="{{ route('orderadmin') }}" class="btn" id="btn-view">View Order Customers</a>
        </div>
    </div>
</div>
