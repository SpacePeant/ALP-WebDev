...
<head>
  ...
  <?php echo app('Illuminate\Foundation\Vite')('resources/css/blog.css'); ?>
  ...
  <div class="scroll-carousel">
    <div class="scroll-track" id="carousel-track">
      <div class="carousel-item">
        <img src="<?php echo e(asset('image/image_carousel/aset_blog1.png')); ?>" alt="Running">
      ...
      <div class="carousel-item">
        <img src="<?php echo e(asset('image/image_carousel/aset_blog2.png')); ?>" alt="Basketball">
      ...
      <div class="carousel-item">
        <img src="<?php echo e(asset('image/image_carousel/aset_blog3.png')); ?>" alt="Casual">
      ...
      <div class="carousel-item">
        <img src="<?php echo e(asset('image/image_carousel/training.png')); ?>" alt="Training">
